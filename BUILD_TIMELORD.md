...
required to run a [Timelord](https://github.com/STATION-I/staidelta-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/STATION-I/staidelta-blockchain/blob/main/install-timelord.sh)

...
from staidelta.util.ints import uint128, uint64, uint32, uint8
...
from staidelta.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo, FoliageBlockData
    ...
    try:
        ...
        for height in range(block_height, block_height + NUM_ITERS):
            ...
            foliage_block_data = FoliageBlockData(
                ...
                rand_hash(),  # officialwallets_reward_puzzle_hash

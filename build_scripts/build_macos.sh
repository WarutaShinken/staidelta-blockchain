...
if [ "$NOTARIZE" == true ]; then
  electron-osx-sign StaiDelta-darwin-x64/StaiDelta.app --platform=darwin \
...
mv StaiDelta-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="StaiDelta-$STAIDELTA_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/StaiDelta-darwin-x64/StaiDelta.app StaiDelta-$STAIDELTA_INSTALLER_VERSION \

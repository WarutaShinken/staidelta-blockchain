...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of staidelta', () => {
      const result = units.getUnit('staidelta');
    ...
    it('gets unit of staidelta using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of staidelta', () => {
      const result = units.getDisplay('staidelta');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('staidelta', 9);

      const result = units.getUnit('staidelta');

      expect(result).toEqual(9);

      units.setUnit('staidelta', 1);
    });
  });
  describe('#setDisplay', () => {

...
import { CardHero, Flex, Link } from '@staidelta/core';
import { PlotHero as PlotHeroIcon } from '@staidelta/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn StaiDelta. '
              }
              <Link
                target="_blank"
                href="https://github.com/STATION-I/staidelta-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>

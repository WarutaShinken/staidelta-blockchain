...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@staidelta/core';
import {
...
import { mojo_to_staidelta_string } from '../../../util/staidelta';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_staidelta_string(props.balance)} TSTAI
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'staidelta_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'staidelta_addr://') {

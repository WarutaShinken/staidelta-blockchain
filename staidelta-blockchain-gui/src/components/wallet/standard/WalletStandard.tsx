...
import {
  ...
  Fee,
  Form,
  TextField as StaiDeltaTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* mojo_to_staidelta_string, */ staidelta_to_mojo } from '../../../util/staidelta';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_staidelta_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of staidelta in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of StaiDelta that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and StaiDelta that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send staidelta to coloured address. Please enter a staidelta
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'staidelta_addr://') {
    ...
    const feeValue = Number.parseFloat(staidelta_to_mojo(fee));

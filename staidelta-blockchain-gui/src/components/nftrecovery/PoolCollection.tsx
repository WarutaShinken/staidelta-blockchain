...
import { Flex, Form, InputBase } from '@staidelta/core';
  ...
  return (
    <Flex flexDirection="column" gap={3}>
      ...
      <Typography variant="body1" color="textSecondary">
        Enter your Chia pool contract address and NFT Launcher ID to recover the missing STAIDELTA from your plot NFT.
      </Typography>

...
from staidelta.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from staidelta.plotting.util import (
    PlotInfo,
    PlotRefreshResult,
        ...
        def process_file(file_path: Path) -> Optional[PlotInfo]:
            ...
            try:
                ...
                if cache_entry is None:
                    ...
                    cache_entry = CacheEntry(pool_public_key, pool_contract_puzzle_hash, plot_public_key, farmer_public_key)

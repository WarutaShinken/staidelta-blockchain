...
from staidelta.consensus.block_header_validation import validate_finished_header_block
...
from staidelta.consensus.get_block_challenge import get_block_challenge
from staidelta.consensus.pot_iterations import calculate_iterations_quality, is_overflow_block
...
from staidelta.util.ints import uint16, uint64, uint32
from staidelta.util.streamable import Streamable, dataclass_from_dict, streamable
...
async def pre_validate_blocks_multiprocessing(
    ...
    for block in blocks:
        ...
        challenge = get_block_challenge(constants, block, BlockCache(recent_blocks, inner=block_records), prev_b is None, overflow, False)

...
from staidelta.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "staidelta" in cc_discrepancies:
                    cc_discrepancies["staidelta"] = cc_discrepancies["staidelta"] + diff
                else:
                    cc_discrepancies["staidelta"] = diff

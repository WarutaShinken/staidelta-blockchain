...
from staidelta.util.condition_tools import parse_sexp_to_conditions
from staidelta.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward, calculate_base_officialwallets_reward
from staidelta.util.config import load_config
from staidelta.util.default_root import DEFAULT_ROOT_PATH
from staidelta.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "staidelta1rdatypul5c642jkeh4yp933zu3hw8vv8tfup8ta6zfampnyhjnusxdgns6"  # Key 1
        address2 = "staidelta1duvy5ur5eyj7lp5geetfg84cj2d7xgpxt7pya3lr2y6ke3696w9qvda66e"  # Key 2
        address3 = "staidelta1duvy5ur5eyj7lp5geetfg84cj2d7xgpxt7pya3lr2y6ke3696w9qvda66e"  # Key 3

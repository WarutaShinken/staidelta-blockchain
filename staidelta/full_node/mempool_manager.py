...
from staidelta.util.cached_bls import LOCAL_CACHE
from staidelta.util.clvm import int_from_bytes
from staidelta.util.condition_tools import pkm_pairs
from staidelta.util.errors import Err, ValidationError
from staidelta.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 STAIDELTA per block, or about 0.00005 STAIDELTA for two
        # spends.

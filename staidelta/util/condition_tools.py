...
from staidelta.types.blockchain_format.sized_bytes import bytes32, bytes48
...
from staidelta.util.errors import ConsensusError, Err
...
def parse_sexp_to_condition(
    ...
    """
    Takes a StaiDeltaLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a StaiDeltaLisp sexp (list) and returns the list of ConditionWithArgss

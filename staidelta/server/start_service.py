...
from staidelta.daemon.server import singleton, service_launch_lock_path
from staidelta.server.ssl_context import staidelta_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"staidelta_{service_name}"
        ...
        staidelta_ca_crt, staidelta_ca_key = staidelta_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = StaiDeltaServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (staidelta_ca_crt, staidelta_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for StaiDeltaServer to be closed")

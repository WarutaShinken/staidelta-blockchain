...
from staidelta.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from staidelta.timelord.iters_from_block import iters_from_block
from staidelta.timelord.timelord_state import LastState
from staidelta.timelord.types import Chain, IterationType, StateType
from staidelta.types.blockchain_format.classgroup import ClassgroupElement
from staidelta.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[StaiDeltaServer] = None
    ...
    def _can_infuse_unfinished_block(self, block: timelord_protocol.NewUnfinishedBlockTimelord) -> Optional[uint64]:
        ...
        timelord_reward_puzzle_hash: bytes32 = decode_puzzle_hash(self.config["staidelta_target_address"])

...
from staidelta.util.ints import uint64, uint32
...
from staidelta.consensus.coinbase import create_pool_coin, create_farmer_coin
from staidelta.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of StaiDeltalisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from staidelta.rpc.full_node_rpc_client

import os
from staidelta.plotters.bladebit import install_bladebit
from staidelta.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        print("StaiDeltapos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/staidelta_plot"):

"""
NOTE: This contains duplicate code from `staidelta.cmds.plots`.
After `staidelta plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "StaiDelta Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_staidelta(args, root_path):

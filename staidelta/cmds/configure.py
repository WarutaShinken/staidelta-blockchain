...
from staidelta.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "beta1_introducer.staideltacoin.com"
            testnet_dns_introducer = "dns-introducer.staideltacoin.com"
            testnet = "testnet7"
            ...
            mainnet_port = "3100"
            mainnet_introducer = "introducer.staideltacoin.com"
            mainnet_dns_introducer = "dns-introducer.staideltacoin.com"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running staidelta services for changes to take effect")

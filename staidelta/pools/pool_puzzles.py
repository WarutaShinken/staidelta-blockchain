...
from staidelta.clvm.singleton import SINGLETON_LAUNCHER
from staidelta.consensus.block_rewards import calculate_pool_reward
from staidelta.consensus.coinbase import pool_parent_id
from staidelta.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from staidelta.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def create_absorb_spend(
    ...
    reward_amount: uint64 = (Decimal(1 / Decimal(farmer_coeff)) * calculate_pool_reward(height))
    if is_pool_member_inner_puzzle(inner_puzzle):
...
def solution_to_pool_state(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the staideltalisp code

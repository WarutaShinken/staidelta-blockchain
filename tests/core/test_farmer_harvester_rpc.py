...
from staidelta.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from staidelta.plotting.manager import PlotManager
from staidelta.protocols import farmer_protocol
from staidelta.rpc.farmer_rpc_api import FarmerRpcApi
from staidelta.rpc.farmer_rpc_client import FarmerRpcClient
from staidelta.rpc.harvester_rpc_api import HarvesterRpcApi
from staidelta.rpc.harvester_rpc_client import HarvesterRpcClient
from staidelta.rpc.rpc_server import start_rpc_server
...
from staidelta.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "staidelta"), encode_puzzle_hash(new_ph_2, "staidelta"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "staidelta"))
            ...
            assert config["farmer"]["staidelta_target_address"] == encode_puzzle_hash(new_ph, "staidelta")
            assert config["pool"]["staidelta_target_address"] == encode_puzzle_hash(new_ph_3, "staidelta")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "staidelta")

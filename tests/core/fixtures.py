...
from staideltacoin.consensus.blockchain import Blockchain
from staideltacoin.consensus.constants import ConsensusConstants
from staideltacoin.full_node.block_store import BlockStore
from staideltacoin.full_node.coin_store import CoinStore
from staideltacoin.types.full_block import FullBlock
from staideltacoin.util.db_wrapper import DBWrapper
from staideltacoin.util.path import mkdir
...
def persistent_blocks(
    ...
    block_path_dir = Path("~/.staideltacoin/blocks").expanduser()
    file_path = Path(f"~/.staideltacoin/blocks/{db_name}").expanduser()

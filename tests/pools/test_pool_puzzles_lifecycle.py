...
from staidelta.wallet.puzzles.p2_conditions import puzzle_for_conditions
from staidelta.wallet.puzzles import singleton_top_layer
from staidelta.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - staidelta.pools.pool_puzzles.py
    - staidelta.wallet.puzzles.pool_member_innerpuz.clvm
    - staidelta.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""

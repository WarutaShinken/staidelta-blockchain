...
from staidelta.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
from staidelta.protocols import full_node_protocol
from staidelta.protocols.full_node_protocol import RespondBlock
...
from staidelta.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestPoolWalletRpc:
    ...
    async def test_absorb_pooling(self, one_wallet_node_and_rpc, fee):
        ...
        # Balance stars at 6 STAIDELTA and 5 more blocks are farmed, total 22 STAIDELTA
    ...
    async def test_leave_pool(self, setup, fee, target_puzzle_hash):
        ...
        try:
            ...
            async def have_staidelta():
                await self.farm_blocks(full_node_api, our_ph, 1)
                return (await wallets[0].get_confirmed_balance()) > 0

            await time_out_assert(timeout=WAIT_SECS, function=have_staidelta)

...
from staidelta.pools.pool_config import PoolWalletConfig
from staidelta.util.config import load_config, save_config, create_default_staidelta_config
...
def test_pool_config():
    ...
    create_default_staidelta_config(test_root, ["config.yaml"])

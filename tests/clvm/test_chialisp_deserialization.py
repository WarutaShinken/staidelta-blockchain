...
from staideltacoin.types.blockchain_format.program import Program, INFINITE_COST
from staideltacoin.util.byte_types import hexstr_to_bytes
from staideltacoin.wallet.puzzles.load_clvm import load_clvm

DESERIALIZE_MOD = load_clvm("chialisp_deserialisation.clvm", package_or_requirement="staideltacoin.wallet.puzzles")

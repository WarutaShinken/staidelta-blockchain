...
wallet_program_files = set(
    [
        "staidelta/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "staidelta/wallet/puzzles/cc.clvm",
        "staidelta/wallet/puzzles/staideltalisp_deserialisation.clvm",
        "staidelta/wallet/puzzles/rom_bootstrap_generator.clvm",
        "staidelta/wallet/puzzles/generator_for_single_coin.clvm",
        "staidelta/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "staidelta/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "staidelta/wallet/puzzles/lock.inner.puzzle.clvm",
        "staidelta/wallet/puzzles/p2_conditions.clvm",
        "staidelta/wallet/puzzles/p2_delegated_conditions.clvm",
        "staidelta/wallet/puzzles/p2_delegated_puzzle.clvm",
        "staidelta/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "staidelta/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "staidelta/wallet/puzzles/p2_puzzle_hash.clvm",
        "staidelta/wallet/puzzles/rl_aggregation.clvm",
        "staidelta/wallet/puzzles/rl.clvm",
        "staidelta/wallet/puzzles/sha256tree_module.clvm",
        "staidelta/wallet/puzzles/singleton_top_layer.clvm",
        "staidelta/wallet/puzzles/did_innerpuz.clvm",
        "staidelta/wallet/puzzles/decompress_puzzle.clvm",
        "staidelta/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "staidelta/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "staidelta/wallet/puzzles/block_program_zero.clvm",
        "staidelta/wallet/puzzles/test_generator_deserialize.clvm",
        "staidelta/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "staidelta/wallet/puzzles/p2_singleton.clvm",
        "staidelta/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "staidelta/wallet/puzzles/pool_member_innerpuz.clvm",
        "staidelta/wallet/puzzles/singleton_launcher.clvm",
        "staidelta/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["staidelta/wallet/puzzles/create-lock-puzzlehash.clvm", "staidelta/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "staidelta/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to staidelta/wallet/puzzles, but not added to `wallet_program_files`
        """

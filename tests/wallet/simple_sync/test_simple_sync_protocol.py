...
from staidelta.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
...
from staidelta.util.ints import uint16, uint32, uint64
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator):
        ...
        from staidelta.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH

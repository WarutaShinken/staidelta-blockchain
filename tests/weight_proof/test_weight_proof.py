...
from staidelta.server.start_full_node import SERVICE_NAME
...
from staidelta.consensus.pot_iterations import calculate_iterations_quality
from staidelta.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
